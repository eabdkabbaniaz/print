...
use App\Jobs\EventOrderExternal;
use App\Jobs\NewOrderPusherNotification;
...
use App\Notifications\NewOrderExternal;
...
class OrderExternalService extends CRUDServices
{
    ...
    public function order2($request)
    {
        ...
        try {
            ...
            $section_id = OrderService::getSection($id);

            /// notify to mychannel to add new order
            dispatch(new EventOrderExternal($order, $section_id));
