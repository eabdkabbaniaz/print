...
class AddressController extends Controller
{
    ...
    {
        try {
            $ad = Address::where('name',$request->city)->first();
            if($ad==null){
                return ResponseService::error('Delivery cannot be made to this area', "  ");
            }
    ...
    {
        $cost = Address::where('parent_id', null)->get();
        // return $cost->cost; 
        return ResponseService::success(' Successfuly', $cost);
    }
    // public function getcity(Request $request)
    // {
    ...
    //  } 
        // return ResponseService::success(' Successfuly', $now->time());
    // }
